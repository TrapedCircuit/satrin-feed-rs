...
//! settings. Bybit uses standard symbol format (`BTCUSDT`) natively and has
//! separate WebSocket endpoints for spot and linear (USDT) futures.
...
pub struct BybitConfig {
    ...
    /// Futures (linear) symbols (e.g. `"BTCUSDT"`).
